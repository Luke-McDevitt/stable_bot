...
**Last revised:** 2026-04-26 (v9 — 3D viewer scaffolded with deferred
full implementation (§11.6); post-deployment iteration plan in §16;
ball-type dropdown in the GUI header captures foam vs ping-pong into
every bag (Q47); pytest unit-test scaffold added for pure-math + config
schemas (Q48).
