...
**Last revised:** 2026-04-26 (v9 — 3D viewer design captured (scaffolded
only, full implementation deferred); plate-parented vs world-frame
trail toggle locked in; post-deployment iteration plan written down
in §16 so we know exactly which backend to flesh out next after the
first hardware test).
...
None — spec locked at v9 (2026-04-26).
